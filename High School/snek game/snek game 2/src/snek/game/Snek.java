...
public class Snek {
    ...
    public JLabel drawHead(int direction, int x, int y){
        ...
        headLabel.setBounds(g.gridSystem_x(x), g.gridSystem_y(y), 45, 45);
        return headLabel;
    }
    ...
    public JLabel drawBody(int direction, int x, int y){
        ...
        bodyLabel.setBounds(g.gridSystem_x(x), g.gridSystem_y(y), 45, 45);
        return bodyLabel;
    }
    ...
    public JLabel drawTail(int direction, int x, int y){
        ...
        tailLabel.setBounds(g.gridSystem_x(x), g.gridSystem_y(y), 45, 45);
        return tailLabel;
    }
